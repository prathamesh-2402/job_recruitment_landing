      ...
      <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20 overflow-hidden">
        <div className="max-w-xl mb-10 md:mx-auto lg:max-w-2xl md:mb-12 flex justify-center">
          <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold leading-none tracking-tight text-gray-900 sm:text-4xl md:mx-auto">
            <span className="relative inline-block" data-aos="zoom-in-up" data-aos-duration="700">
              <svg
                viewBox="0 0 52 24"
                fill="currentColor"
              ...
              <span className="relative text-transparent bg-clip-text bg-gradient-to-r from-[#35A29F] to-[#0B666A]">
                Our Awards
              </span>
            </span>{" "}
          </h2>
        ...
        <div className="grid gap-8 row-gap-8 lg:grid-cols-4">
          <div className="flex flex-col items-center">
            ...
            >
              <img src="https://img.icons8.com/external-konkapp-outline-color-konkapp/64/null/external-trading-stay-at-home-konkapp-outline-color-konkapp.png" />
            </div>
            <h6 className="mb-2 font-semibold leading-5" data-aos="fade-right" data-aos-duration="700">
              Best Recruitement Platform
            </h6>
            <p
          ...
          <div className="flex flex-col items-center">
            <div
              ...
              data-aos-duration="700"
            >
              <img src="https://img.icons8.com/emoji/48/null/trophy-emoji.png" />
            </div>
  
            <h6 className="mb-2 font-semibold leading-5" data-aos="fade-right">
              Best Job Platform Asia
            </h6>
            <p
              className="max-w-md mb-3 text-sm text-gray-900 sm:mx-auto"
              data-aos="fade-left"
          ...
          <div className="flex flex-col items-center">
            <div
              ...
              data-aos-duration="700"
            >
              <img src="https://img.icons8.com/external-flaticons-flat-flat-icons/64/null/external-trading-copyright-law-flaticons-flat-flat-icons-2.png" />
            </div>
            <h6 className="mb-2 font-semibold leading-5" data-aos="fade-right">
