export const Pricing = () => {
    return (
      <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20 overflow-hidden">
        <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12" data-aos="fade-up" data-aos-delay="200"
        ...
        <div className="grid max-w-md gap-10 row-gap-5 sm:row-gap-10 lg:max-w-screen-md lg:grid-cols-2 sm:mx-auto">
          <div className="flex flex-col justify-between p-5 bg-white border rounded shadow-sm" data-aos="flip-left" data-aos-delay="300"
            data-aos-duration="700">
            <div className="mb-6">
            ...
            <div>
              <a
                href="/"
                className="inline-flex items-center justify-center w-full h-12 px-6 mb-4 font-medium tracking-wide text-gray-900 transition duration-200 bg-gray-200 rounded shadow-md hover:bg-gray-600 hover:text-gray-100 focus:shadow-outline focus:outline-none"
              >
                Start for free
              </a>
          ...
          <div className="flex flex-col justify-between p-5 bg-white border rounded shadow-sm" data-aos="flip-right" data-aos-delay="300"
            data-aos-duration="700">
            <div className="mb-6">
              <div className="flex items-center justify-between pb-6 mb-6 border-b">
                <div>
                  ...
                  <p className="text-5xl font-extrabold">$5.99</p>
                </div>
              ...
              <div>
                ...
                <ul className="space-y-2">
                  <li className="flex items-center">
                    ...
                    <p className="font-medium text-gray-800">Unlimited lorem ipsum</p>
                  </li>
                  <li className="flex items-center">
                    <div className="mr-2">
                      <svg
                  ...
                  <li className="flex items-center">
                    ...
                    <p className="font-medium text-gray-800">Faster lorem ipsum</p>
                  </li>
                  <li className="flex items-center">
                    <div className="mr-2">
                      <svg
                  ...
                  <li className="flex items-center">
                    ...
                    <p className="font-medium text-gray-800">Global lorem ipsum</p>
                  </li>
                </ul>
              </div>
            </div>
            <div>
              <a
                href="/"
                className="inline-flex items-center justify-center w-full h-12 px-6 mb-4 font-medium tracking-wide text-white transition duration-200 rounded shadow-md bg-[#35A29F] hover:bg-[#071952] focus:shadow-outline focus:outline-none"
              >
                Get started
              </a>
              <p className="text-sm text-gray-600">
